...
conv_upsampling_2 = Conv2DTranspose(filters=n_classes, kernel_size=(16,16), strides=(16,16), padding='same')(skip_connection_1)
reshaped_layer = Reshape((-1, n_classes))(conv_upsampling_2)
scores = Activation('softmax')(reshaped_layer)

fcn16 = Model(vgg16.input, output=scores)
#fcn16.summary()
